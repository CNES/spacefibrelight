...
entity phy_plus_lane is
   port(
      ...
      CLK                              : in  std_logic;                       --! main clock for spacefibre IP (used as freerunning clock for HSSL)
      -- Reset_gen interface 
...
------------------------------------------------------------------------------ 
   ...
   p_cdc_command_from_link: process(clk_tx)
   begin
   ...
   lane_reset_cmd_dl_i <= ctrl_in_dl_sync(8);
   ...
   port map (
      ...
      -- RX signals
      LANE_RESET_DL                    => lane_reset_cmd_dl_i,
