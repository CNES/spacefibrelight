...
signal no_signal,no_signal_a,no_signal_a_r      : std_logic;                        --! value 1 when GTY is in high Z (electrical idle) and the init lane state machine requires use of this signal
...
--------------- beginning of conditionnal port map ------------
   ...
   process(clk_usr_gty,rst_usr_gty_n) then)
   begin
