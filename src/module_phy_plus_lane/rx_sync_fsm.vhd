   ...
   begin
      if RST_N = '0' then
         ...
         case current_state is
            ...
            when CHECK_SYNC_ST  =>  if LANE_RESET = '1'   or ((rx_word_realign_from_ip_r = '1' and rx_word_realign_from_ip_rr = '0') or rx_word_realign_from_ip_r = '1') or err_word_x5 = '1' then
                                       current_state  <= LOST_SYNC_ST;
            ...
            when READY_ST       =>  if LANE_RESET = '1'  or ((rx_word_realign_from_ip_r = '1' and rx_word_realign_from_ip_rr = '0') or rx_word_realign_from_ip_r = '1') then
                                       current_state  <= LOST_SYNC_ST;
      ...
      if RST_N = '0' then
         ...
         if current_state = LOST_SYNC_ST then
            ...
            if DATA_RDY_FROM_IP = '1' then                           -- when a data is receive from MANUFACTURER IP
               ...
               valid_k_charac_to_lcwd_i   <= x"0";                      -- no data received
               data_rdy_to_lcwd_i         <= '0';                       -- no data received
            end if;
