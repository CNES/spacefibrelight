...
--               It receives data from phy plus lane and analyses frames format         
----------------------------------------------------------------------------
...
entity data_word_id_fsm is
  port (
   ...
   -- FIXME : link reset is a command it is not supposed to be a system reset . A system reset must be add to this module and LINK_RESET_DLRE should be used as a normal signal
