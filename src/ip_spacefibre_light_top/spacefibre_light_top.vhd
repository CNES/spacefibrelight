...
entity spacefibre_light_top is
   ...
   port (
      ...
      CLK                              : in  std_logic;                            --! Main clock for Spacefibre IP
...
architecture rtl of spacefibre_light_top is
   ...
   component phy_plus_lane is
      port(
         ...
         RST_GTY_DONE                      : out std_logic;                       -- Up when GTY reset done
         -- CLK GTY signals
   ...
   component phy_plus_lane_64b is
      port(
         ...
         -- Reset_gen interface
         LANE_RESET_PPL_OUT               : out std_logic;
         CLK_TX_OUT                       : out std_logic;                       -- user clock
   ...
   signal rst_gty_done                        : std_logic;                         --! Up when gty reset done
...
begin
   ...
   -- FIXME  find away to avoid VHDL2008 and keep compatible cocotb simulation
   ...
   --);
   -- FIXME : clean up reset tree by removing call to RST_TXCLK_N like for versal
   -- 
