...
{PMC_MIO 26 .. 36}}} \
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins DATALINK_CONFIGURATOR/reset_n] [get_bd_pins LANE_GENERATOR/reset_n] [get_bd_pins LANE_ANALYZER/aresetn] [get_bd_pins DATALINK_GENERATOR/RST_N] [get_bd_pins DATALINK_ANALYZER/RST_N] [get_bd_ports reset_n_fpga] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins DATALINK_CONFIGURATOR/RST_TXCLK_N]
